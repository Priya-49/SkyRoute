...
public sealed class DatabaseMigrationApplyTests
{
    ...
    [Fact]
    public void Database_CanConnect_AndBookingsTableExistsWithExpectedIndexes()
    {
        ...
        Assert.Equal(1, ExecuteCount(connection, "SELECT COUNT(1) FROM sys.indexes WHERE name = 'IX_Bookings_FlightId'"));
    }
